...
#ifdef          LINEAR1
#define                 MSG1		"ReadMWrite:Linear1:Good:"
#endif
#ifdef          LINEAR2
#define                 MSG1		"ReadMWrite:Linear2:Good:"
#endif
#ifdef          RANDOM1
#define                 MSG1		"ReadMWrite:Random1:Bad-MA:"
#endif
#ifdef          RANDOM2
#define                 MSG1		"ReadMWrite:Random2:Bad-MA:"
#endif
#ifdef          STRIDE
#define                 MSG1		"ReadMWrite:Stride="
#endif
#define		MSG2		"N=%d:DataSize=%dKB:Elapsed(msec)=%.2f:"

float elapsedTime(struct timespec *, struct timespec *, long *, long *);

TYPE A[N], B[N];
int main (int argc, char * argv[])
{
  int             i, j, k, m, mask, stride, temp;
  TYPE            result=0;
  int64_t         sum2=0;
